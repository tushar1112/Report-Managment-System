...
// Student Report Managment System project using c++ ans file input/output .
...
class student
{
     int rollno;
     char name[50];
     int eng_marks, math_marks, sci_marks, social_sci_marks, cs_marks;
     double average;
     char grade;
...
{
     average = (eng_marks + math_marks + sci_marks + social_sci_marks + cs_marks) / 5.0;
     if (average >= 90)
          grade = 'A';
     else if (average >= 75)
          grade = 'B';
